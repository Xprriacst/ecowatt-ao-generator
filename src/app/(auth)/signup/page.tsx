        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 disabled:opacity-50"
            >
          ...
          <p className="mt-6 text-center text-xs text-gray-500">
            ...
            <Link href="/cgu" className="text-blue-600">CGU</Link> et{' '}
            <Link href="/privacy" className="text-blue-600">Politique de confidentialité</Link>
          </p>
        </div>
      </div>
    </div>
